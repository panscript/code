...
export class CustomParser extends Parser {
	...
	private static readonly _LITERAL_NAMES: Array<string | undefined> = [
		undefined, undefined, "'verdadeiro'", "'falso'", "'interrompa'", "'constante'", 
		"'continue'", "'senao'", "'fim'", "'para'", "'para sempre'", "'de'", "'funcao'", 
		"'global'", "'se'", "'retorne'", "'retorna'", "'ate'", "'enquanto'", undefined, 
		undefined, undefined, "'logico'", "'numero'", "'texto'", "'='", "'+'", 
		"'-'", "'*'", "'/'", "'%'", "'^'", "'+='", "'-='", "'*='", "'/='", "'%='", 
		"'^='", "'<'", "'<='", "'>'", "'>='", "'=='", "'!='", "'('", "')'", "'['", 
		"']'", "'{'", "'}'", "'.'", "','",
	];
